            ...
            <section style="display: flex; flex-direction: column; gap: 1rem;">
                <div class="quarters-grid" style="grid-template-columns: 1fr 1fr;">
                    ...
                    <div class="card" style="padding: 1.5rem 2rem; position: relative;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem;">
                            <div>
                                <div style="font-family: 'Outfit', sans-serif; font-size: 1.3rem; font-weight: 700; color: var(--text-primary);">Выполнено задач по категориям</div>
        ...
        function renderJiraDashboard() {
            ...
            const jiraCategoriesStackedData = {
                q1: {
                    ...
                    datasets: [
                        { label: "Ранее", data: [68, 114, 5, 227, 101, 2], backgroundColor: "#06b6d4" },
                ...
                q2: {
                    ...
                    datasets: [
                        { label: "Ранее", data: [35, 58, 1, 146, 68, 1], backgroundColor: "#06b6d4" },
                        { label: "Прошлый месяц", data: [15, 26, 0, 45, 54, 0], backgroundColor: "#eab308" },
                        { label: "Текущий месяц", data: [0, 0, 0, 0, 0, 0], backgroundColor: "#10b981" }
                    ]
                },
                all: {
                    ...
                    datasets: [
                        { label: "Ранее", data: [103, 172, 6, 373, 169, 3], backgroundColor: "#06b6d4" },
                        { label: "Прошлый месяц", data: [15, 26, 0, 45, 54, 0], backgroundColor: "#eab308" },
                        { label: "Текущий месяц", data: [0, 0, 0, 0, 0, 0], backgroundColor: "#10b981" }
                    ]
                }
