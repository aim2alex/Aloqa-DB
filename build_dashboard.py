...
<body>
    ...
    <div class="container">
        ...
        <div id="panel-jira" class="main-panel">
            ...
            <section style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1.5rem;">
                <div class="quarters-grid" style="grid-template-columns: 1fr 1.1fr;">
                    ...
                    <div class="card" style="padding: 1.5rem 2rem; position: relative;">
                        ...
                        <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 1.25rem; align-items: center; margin-top: 1rem; min-height: 220px;">
                            ...
                            <div style="position: relative; width: 150px; height: 150px; margin: 0 auto;">
                                ...
                                <div class="doughnut-center-card" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: var(--card-bg); border: 1px solid var(--card-border); box-shadow: 0 8px 24px rgba(0,0,0,0.08); width: 85px; height: 85px; border-radius: 50%; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; pointer-events: none; z-index: 5;">
                                    <span style="font-size: 0.6rem; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.05em; font-weight: 600;">Всего</span>
                                    <span id="doughnut-jira-time-center-value" style="font-size: 1.1rem; font-weight: 700; color: var(--text-primary); margin-top: 1px; line-height: 1;">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    options: {
                        ...
                        scales: {
                            x: {
                                ...
                                ticks: { color: axisColors.textSecondary, font: { size: 10 } }
                            },
                            y: {
                                stacked: true,
                                grid: { display: false },
